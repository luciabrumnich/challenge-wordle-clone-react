...
function Board() {
  //El valor de letterPosition vuelve a 0 con cada intento, pero el valor de los intentos se va incrementando en 1
  //Para la matriz, pensé también la opción de realizar un componente Line, y utilizar map(). Entonces la props attemptValue debería pasar al padre (variaría) para que luego se la pase al child. De esa manera nos ahorraríamos muchas líneas de código acá.
  return (
    <div className="board">
      {""}
      <div className="row">
